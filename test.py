svg = '''<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 24 24" fill="#0c66e4" stroke="#0c66e4" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round">
...
with open('test_hand.svg', 'w') as f:
    f.write(svg)
